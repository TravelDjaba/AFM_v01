...
const libSP_dll = 'libserialport.dll';
...
{* Standard flow control combinations. }
 Psp_flowcontrol=^sp_flowcontrol;
 sp_flowcontrol =(
	{* No flow control. }
 ...
 * An opaque structure representing the configuration for a serial port.
 ...
 PPsp_port_config=^Psp_port_config;
 Psp_port_config=^sp_port_config;
 sp_port_config = record
 end;
 ...
 * A set of handles to wait on for events.
 ...
 PPsp_event_set=^sp_event_set;
 Psp_event_set=^sp_event_set;
 sp_event_set = record
...
function sp_get_port_by_name(const portname:PAnsiChar;  port_ptr:PPsp_port):sp_return; cdecl; external libSP_dll;
...
procedure sp_free_port( port:Psp_port); cdecl ; external libSP_dll;
...
function sp_list_ports( list_ptr:PPPsp_port):sp_return; cdecl ; external libSP_dll;
...
function sp_copy_port(const port:Psp_port; copy_ptr:PPsp_port):sp_return; cdecl ; external libSP_dll;
...
procedure sp_free_port_list(ports:PPsp_port); cdecl ; external libSP_dll;
...
function sp_open( port:Psp_port; flags:sp_mode):sp_return; cdecl ; external libSP_dll;
...
function sp_close(port:Psp_port):sp_return; cdecl ; external libSP_dll;
...
function sp_get_port_name(const port:Psp_port):PAnsiChar; cdecl ; external libSP_dll;
...
function sp_get_port_description(const port:Psp_port):PAnsiChar; cdecl ; external libSP_dll;
...
function sp_get_port_transport(const port:Psp_port):sp_transport; cdecl ; external libSP_dll;
...
function sp_get_port_usb_bus_address(const port:Psp_port;
                                           usb_bus:PInteger; usb_address:PInteger):sp_return; cdecl ; external libSP_dll;
...
function sp_get_port_usb_vid_pid(const port:Psp_port; usb_vid:PInteger; usb_pid:PInteger):sp_return; cdecl ; external libSP_dll;
...
function sp_get_port_usb_manufacturer(const port:Psp_port):PAnsiChar; cdecl ; external libSP_dll;
...
function sp_get_port_usb_product(const port:Psp_port):PAnsiChar; cdecl ; external libSP_dll;
...
function sp_get_port_usb_serial(const port:Psp_port):PAnsiChar; cdecl ; external libSP_dll;
...
function sp_get_port_bluetooth_address(const port:Psp_port):PAnsiChar; cdecl ; external libSP_dll;
...
function sp_get_port_handle(const port:Psp_port; result_ptr:Pointer):sp_return; cdecl ; external libSP_dll;
...
function sp_new_config(config_ptr:PPsp_port_config):sp_return; cdecl ; external libSP_dll;
...
procedure sp_free_config(config:Psp_port_config); cdecl ; external libSP_dll;
...
function sp_get_config( port:Psp_port; config:Psp_port_config):sp_return; cdecl ; external libSP_dll;
...
function sp_set_config(port:Psp_port; const config:Psp_port_config):sp_return; cdecl ; external libSP_dll;
...
function sp_set_baudrate(port:Psp_port; baudrate:Integer):sp_return; cdecl ; external libSP_dll;
...
function sp_get_config_baudrate(const config:Psp_port_config; baudrate_ptr:PInteger):sp_return; cdecl ; external libSP_dll;
...
function sp_set_config_baudrate(config:Psp_port_config; baudrate:Integer):sp_return; cdecl ; external libSP_dll;
...
function sp_set_bits(port:Psp_port; bits:Integer):sp_return; cdecl ; external libSP_dll;
...
function sp_get_config_bits(const config:Psp_port_config; bits_ptr:PInteger):sp_return; cdecl ; external libSP_dll;
...
function sp_set_config_bits(config:Psp_port_config; bits:Integer):sp_return; cdecl ; external libSP_dll;
...
function sp_set_parity(port:Psp_port; parity:sp_parity):sp_return; cdecl ; external libSP_dll;
...
function sp_get_config_parity(const config:Psp_port_config; parity_ptr:Psp_parity):sp_return; cdecl ; external libSP_dll;
...
function sp_set_config_parity(config:Psp_port_config; parity:sp_parity):sp_return; cdecl ; external libSP_dll;
...
function sp_set_stopbits(port:Psp_port; stopbits:Integer):sp_return; cdecl ; external libSP_dll;
...
function sp_get_config_stopbits(const config:Psp_port_config; stopbits_ptr:Pinteger):sp_return; cdecl ; external libSP_dll;
...
function sp_set_config_stopbits(config:Psp_port_config; stopbits:Integer):sp_return; cdecl ; external libSP_dll;
...
function sp_set_rts(port:Psp_port; rts:sp_rts):sp_return; cdecl ; external libSP_dll;
...
function sp_get_config_rts(const config:Psp_port_config; rts_ptr:Psp_rts):sp_return; cdecl ; external libSP_dll;
...
function sp_set_config_rts(config:Psp_port_config; rts:sp_rts):sp_return; cdecl ; external libSP_dll;
...
function sp_set_cts(port:Psp_port; cts:sp_cts):sp_return; cdecl ; external libSP_dll;
...
function sp_get_config_cts(const config:Psp_port_config; cts_ptr:Psp_cts):sp_return; cdecl ; external libSP_dll;
...
function sp_set_config_cts(config:Psp_port_config; cts:sp_cts):sp_return; cdecl ; external libSP_dll;
...
function sp_set_dtr(port:Psp_port; dtr:sp_dtr):sp_return; cdecl ; external libSP_dll;
...
function sp_get_config_dtr(const config:Psp_port_config; dtr_ptr:Psp_dtr):sp_return; cdecl ; external libSP_dll;
...
function sp_set_config_dtr(config:Psp_port_config; dtr:sp_dtr):sp_return; cdecl ; external libSP_dll;
...
function sp_set_dsr(port:Psp_port; dsr:sp_dsr):sp_return; cdecl ; external libSP_dll;
...
function sp_get_config_dsr(const config:Psp_port_config; dsr_ptr:Psp_dsr):sp_return; cdecl ; external libSP_dll;
...
function sp_set_config_dsr(config:Psp_port_config; dsr:sp_dsr):sp_return; cdecl ; external libSP_dll;
...
function sp_set_xon_xoff(port:Psp_port; xon_xoff:sp_xonxoff):sp_return; cdecl ; external libSP_dll;
...
function sp_get_config_xon_xoff(const config:Psp_port_config; xon_xoff_ptr:Psp_xonxoff):sp_return; cdecl ; external libSP_dll;
...
function sp_set_config_xon_xoff(config:Psp_port_config; xon_xoff:sp_xonxoff):sp_return; cdecl ; external libSP_dll;
...
function sp_set_config_flowcontrol(config:Psp_port_config; flowcontrol:sp_flowcontrol):sp_return; cdecl ; external libSP_dll;
...
function sp_set_flowcontrol(port:Psp_port; flowcontrol:sp_flowcontrol):sp_return; cdecl ; external libSP_dll;
...
function sp_blocking_read(port:Psp_port; buf:Pointer; count:size_t; timeout_ms:UInt32):sp_return; cdecl ; external libSP_dll;
...
function sp_blocking_read_next(port:Psp_port; buf:Pointer; count:size_t; timeout_ms:UInt32):sp_return; cdecl ; external libSP_dll;
...
function sp_nonblocking_read(port:Psp_port; buf:Pointer; count:size_t ):sp_return; cdecl ; external libSP_dll;
...
function sp_blocking_write(port:Psp_port; const buf:Pointer; count:size_t; timeout_ms:UInt32):sp_return; cdecl ; external libSP_dll;
...
function sp_nonblocking_write(port:Psp_port; const buf:Pointer; count:size_t ):sp_return; cdecl ; external libSP_dll;
...
function sp_input_waiting(port:Psp_port):sp_return; cdecl ; external libSP_dll;
...
function sp_output_waiting(port:Psp_port):sp_return; cdecl ; external libSP_dll;
...
function sp_flush(port:Psp_port; buffers:sp_buffer):sp_return; cdecl ; external libSP_dll;
...
function sp_drain(port:Psp_port):sp_return; cdecl ; external libSP_dll;
...
function sp_new_event_set(result_ptr:PPsp_event_set):sp_return; cdecl ; external libSP_dll;
...
function sp_add_port_events(event_set:Psp_event_set;
	const port:Psp_port; mask:sp_event):sp_return; cdecl ; external libSP_dll;
...
function sp_wait(event_set:Psp_event_set; timeout_ms:UInt32):sp_return; cdecl ; external libSP_dll;
...
procedure sp_free_event_set(event_set:Psp_event_set); cdecl ; external libSP_dll;
...
function sp_get_signals(port:Psp_port; signal_mask:Psp_signal):sp_return; cdecl ; external libSP_dll;
...
function sp_start_break(port:Psp_port):sp_return; cdecl ; external libSP_dll;
...
function sp_end_break(port:Psp_port):sp_return; cdecl ; external libSP_dll;
...
function sp_last_error_code():integer; cdecl ; external libSP_dll;
...
function sp_last_error_message():PAnsiChar; cdecl ; external libSP_dll;
...
procedure sp_free_error_message(message:PAnsiChar); cdecl ; external libSP_dll;
...
function sp_get_major_package_version():Integer; cdecl ; external libSP_dll;
...
function sp_get_minor_package_version():Integer; cdecl ; external libSP_dll;
...
function sp_get_micro_package_version():Integer; cdecl ; external libSP_dll;
...
function sp_get_package_version_string():PAnsiChar; cdecl ; external libSP_dll;
...
function sp_get_current_lib_version():Integer; cdecl ; external libSP_dll;
...
function sp_get_revision_lib_version():Integer; cdecl ; external libSP_dll;
...
function sp_get_age_lib_version():Integer; cdecl ; external libSP_dll;
...
function sp_get_lib_version_string():PAnsiChar; cdecl ; external libSP_dll;
